    ...
    >
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-[30%]">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                We provide end to end service to our client right from
                Incorporation to getting registrations, getting their books
                audited. We make assure that our client gets solution to all its
                requirements .
              </p>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-[20%]">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">
                Useful Links
              </h4>
          ...
          <div className="flex flex-col space-y-2 w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12 text-gray-7">
            <h2 className="font-semibold text-lg text-white">Contact Info</h2>
            <p>
            ...
            <p>
              ...
              <a
                href="mailto:contact@bizzonns.com"
            ...
            <p>
              ...
              <a
                href="tel:+9102249689516"
                className="hover:text-blue-500 dark:hover:text-blue-300"
              >
                +91 022-4968 9516
              </a>
            </p>
            <h3 className="font-semibold text-md mt-4 text-white">
              Business Hours
            </h3>
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-base text-gray-7">
                  © 2024 Bizzonns. All rights reserved.
                </p>
              </div>
            </div>
          </div>
